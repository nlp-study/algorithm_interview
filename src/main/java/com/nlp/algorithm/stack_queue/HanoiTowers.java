...
public class HanoiTowers {
	...
	public static int process1(int num,String right,String mid,String left,String from,String to)
	{
		if(num==1)
		{
			...
			{
				System.out.println("move1  " + num + " from "+ from + " to " + to);
				return 1;
			}
			else
			{
				System.out.println("move1  " + num + " from "+ from + " to " + mid);
				System.out.println("move1  " + num + " from "+  mid + " to " + to);
				return 2;
			}
		}
		...
		if(from.equals(mid) || to.equals(mid))
		{
			...
			int size2 = 1;
			System.out.println("move2  " + num + " from "+from + " to " + to);
		...
		}else
		{
			...
			int size2 = 1;
			System.out.println("move3  " + num + " from "+from + " to " + mid);
			
			int size3 = process1( num-1, right, mid, left, to, from);
			int size4 = 1;
			System.out.println("move3  " + num + " from "+mid + " to " + to);
